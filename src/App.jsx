...
// Fake data to aid with development
const DEFAULT_CARDS = [
  // BACKLOG
  { title: "Find an alternative to MongoDB", id: "1", column: "backlog" },
  { title: "Learn AWS", id: "2", column: "backlog" },
  { title: "Fix the bug that is bugging you *badum tss*", id: "3", column: "backlog" },
  // TODO
  {
    title: "Get a job",
    id: "5",
  ...
  { title: "Cook yourself a meal", id: "6", column: "todo" },
  { title: "Call your family", id: "7", column: "todo" },
  ...
  { title: "Finish the Coffee Tracker app", id: "9", column: "done" },
  // DONE
  {
    title: "Wake up",
    id: "10",
...
const Bin = ({ setCards }) => {
  ...
  return <div onDrop={handleDragEnd} onDragOver={handleDragOver} onDragLeave={handleDragLeave} className={`mt-10 grid h-56 w-56 shrink-0 place-content-center rounded border text-3xl 
    ${active ? 
...
const Card = ({title, id, column, handleDragStart}) => {
  return (
    <>
      ...
      <motion.div layout layoutId={id} onDragStart={(e) => handleDragStart(e, {title, id, column})} draggable="true" className="cursor-grab rounded border border-neutral-700 bg-neutral-800 p-3 active:cursor-grabbing">
  ...
  return (
    <div className="w-56 shrink-0">
      ...
      <div onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDragEnd} className={`h-full w-full transition-colors ${active ? "bg-neutral-800/50" : "bg-neutral-800/0"}`}>
        ...
        <DropIndicator DropIndicator="-1" column={column} />
